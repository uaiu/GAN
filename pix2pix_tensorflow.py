...
IMG_HEIGHT = 256
#%%
def train_test_divide(data, data_length):
    train = data[:data_length-10,:,:,:]
    test = data[data_length-10:data_length,:,:,:]
    
    return train, test
#%%

noise_ab_train , noise_ab_test = train_test_divide(AB_noise, AB_length)
noise_ax_train , noise_ax_test = train_test_divide(AX_noise, AX_length)
noise_ba_train , noise_ba_test = train_test_divide(BA_noise, BA_length)
noise_bd_train , noise_bd_test = train_test_divide(BD_noise, BD_length)
noise_dn_train , noise_dn_test = train_test_divide(DN_noise, DN_length)
noise_ks_train , noise_ks_test = train_test_divide(KS_noise, KS_length)
noise_su_train , noise_su_test = train_test_divide(SU_noise, SU_length)
noise_kp_train , noise_kp_test = train_test_divide(KP_noise, KP_length)
