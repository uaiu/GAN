...
clean_path = 'C:/Users/NGV32/.spyder-py3/hyundai_project/data/noise_wav/'
...
ang_max_test = ang_max[len(ang_max)-test_count:len(ang_max)]
ang_min_test = ang_min[len(ang_min)-test_count:len(ang_min)]
#%%
...
for inp, tar in test_dataset.take(40):
  ...
  max_ang_clean = ang_max_test[count]
  min_ang_clean = ang_min_test[count]
  ...
  gen_stft = real_to_complex(gen_db_amp, gen_unwrap_ang)
  gen_angle_stft = real_to_complex(gen_db_amp, gen_unwrap_orang)
  gt_stft = real_to_complex(gt_db_amp, gt_unwrap_ang)

  gen_wav = librosa.istft(gen_stft, hop_length = hop_length, win_length=n_fft)
  gen_angle_wav = librosa.istft(gen_angle_stft, hop_length = hop_length, win_length=n_fft)
  ...
  soundfile.write('C:/Users/NGV32/.spyder-py3/hyundai_project/output/1060ea_prediction_originalangle/orangle_wav_{}.wav' .format(count), gen_angle_wav, sr)
...
max_mag = mag_max[:15] + mag_max[211:226] + mag_max[402:412]
min_mag = mag_min[:15] + mag_min[211:226] + mag_min[402:412]
...
for inp, tar in test_dataset.take(40):
  ...
  gen_denorm = denormalization(gen_mag, -1, 1, max_mag_clean, min_mag_clean)
  gt_denorm = denormalization(gt_mag, -1, 1, max_mag_clean, min_mag_clean)
  ...
  soundfile.write('C:/Users/NGV32/.spyder-py3/hyundai_project/output/524ea_prediction_griffinlim/griffin_wav_{}.wav' .format(count), gen_wav, sr)
  #soundfile.write('C:/Users/NGV32/.spyder-py3/hyundai_project/output/524ea_ground_truth_griffinlim/gt_wav_{}.wav' .format(count), gt_wav, sr)
